    ...
    if (registerFormElement) {
        registerFormElement.addEventListener("submit", function (registrationEvent) {
            ...
            let registeredUsersList = JSON.parse(localStorage.getItem("usersList")) || [];
            const existingUser = registeredUsersList.find((userObject) => userObject.username === usernameInputValue);
            ...
            registeredUsersList.push({ username: usernameInputValue, password: passwordInputValue });
